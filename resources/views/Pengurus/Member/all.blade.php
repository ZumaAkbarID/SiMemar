    ...
    <script>
        function getTbMember(status) {
            if (status == 'Aktif') {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_table', 'Aktif') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_table', 'Non Aktif') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_table', 'Pending') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_table', 'Ditolak') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
        ...
        function getCounterMember(status) {
            if (status == 'Aktif') {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_counter', 'Aktif') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_counter', 'Non Aktif') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_counter', 'Pending') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('Pengurus_member_get_counter', 'Ditolak') }}",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    dataType: 'html',
        ...
        function detailMember(code) {
            $.ajax({
                type: 'POST',
                url: "{{ route('Pengurus_member_detail') }}",
                data: {
                    acc_code: code,
                    _token: '{{ csrf_token() }}'
                },
        ...
        function editMember(code) {
            $.ajax({
                type: 'POST',
                url: "{{ route('Pengurus_member_edit_form') }}",
                data: {
                    acc_code: code,
                    _token: '{{ csrf_token() }}'
                },
        ...
        function deleteMember(code, uid) {
            $.ajax({
                type: 'POST',
                url: "{{ route('Pengurus_member_delete_ask') }}",
                data: {
                    acc_code: code,
                    _token: '{{ csrf_token() }}'
                },
                ...
                success: function(result) {
                    ...
                    modalConfirm(function(confirm) {
                        if (confirm) {
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('Pengurus_member_delete_confirm') }}",
                                data: {
                                    acc_code: code,
                                    uid: uid,
                                    _token: '{{ csrf_token() }}'
