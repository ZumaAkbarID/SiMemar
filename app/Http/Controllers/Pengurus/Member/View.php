...
class View extends Controller
{
    ...
    public function all()
    {
        return view('Pengurus.Member.all', [
    ...
    public function detail(Request $request)
    {
        ...
        return view('Pengurus.Member.Ajax._detail', [
            'data' => $user,
            'cv' => $cv
        ]);
    }
